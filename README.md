...
<body>
   <div style="width: 100%; height: 100%; justify-content: flex-start; align-items: flex-start; gap: 48px; display: inline-flex">
      <div style="width: 360px; height: 640px; position: relative; background: #FF0808">
          ...
          <img style="width: 126px; height: 126px; left: 117px; top: 117px; position: absolute" src="https://via.placeholder.com/126x126" />
      ...
      <div style="width: 343px; height: 640px; position: relative; background: #D5F608">
          <div style="width: 300px; height: 37px; left: 22px; top: 26px; position: absolute; text-align: center; color: #FA1B1B; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word">Saveetha Engineering College</div>
          <div style="width: 360px; height: 0px; left: -8px; top: 83.05px; position: absolute; border: 4px #172DF5 solid"></div>
          <img style="width: 126px; height: 126px; left: 109px; top: 126px; position: absolute" src="https://via.placeholder.com/126x126" />
      ...
      <div style="width: 360px; height: 640px; position: relative; background: #FF0808; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25) inset">
          <div style="width: 300px; height: 37px; left: 47px; top: 23px; position: absolute; text-align: center; color: white; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word">Saveetha Engineering College</div>
          <div style="width: 360px; height: 0px; left: 0px; top: 75.05px; position: absolute; border: 4px #172DF5 solid"></div>
          <img style="width: 82px; height: 82px; left: 130px; top: 99px; position: absolute" src="https://via.placeholder.com/82x82" />
          ...
          <div style="width: 270px; height: 288px; left: 48px; top: 275px; position: absolute; background: #D9D9D9"></div>
